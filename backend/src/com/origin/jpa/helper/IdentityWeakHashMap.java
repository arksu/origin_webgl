 ...
 * not equals(). This is required to track objects throughout the lifecycle, regardless if the domain
...
public class IdentityWeakHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable
{
	...
	public boolean containsValue(Object obj)
	{
		if (obj == null)
		{
			throw new IllegalArgumentException("Null not supported  IdentityWeakHashMap");
		}
	...
	{
		WeakEntry[] entries = this.entries;
		...
		public boolean hasNext()
		{
			WeakEntry e = entry;
			int i = index;
			WeakEntry[] copyOfEntries = this.entries;
