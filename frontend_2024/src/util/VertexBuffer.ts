...
export default class VertexBuffer {
    ...
    public addVertex(x: number, y: number, w: number, h: number, t: PIXI.Texture): void {
        ...
        this._uv[index] = t.uvs.x0
        this._uv[index + 1] = t.uvs.y0
        this._uv[index + 2] = t.uvs.x1
        this._uv[index + 3] = t.uvs.y1
        this._uv[index + 4] = t.uvs.x2
        this._uv[index + 5] = t.uvs.y2
        this._uv[index + 6] = t.uvs.x3
        this._uv[index + 7] = t.uvs.y3
